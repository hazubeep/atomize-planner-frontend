...
const HeroMockup = () => (
  <div className="relative w-full max-w-[clamp(520px,52vw,920px)]">
...
const LandingPage = () => {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-bg">
      ...
      <div
        className="min-h-[calc(100vh-56px)] flex-1 bg-[radial-gradient(ellipse_at_top_right,#BFEBE433_0%,transparent_55%)]"
      >
        <Section className="pt-[clamp(84px,8.5vw,140px)] pb-[clamp(96px,9vw,160px)]">
          <div className="grid items-center gap-[clamp(40px,6vw,90px)] [grid-template-columns:1.05fr_0.95fr]">
            <div className="relative z-[2]">
              <h1 className="mb-[clamp(16px,2.2vw,28px)] font-display text-[clamp(54px,6.2vw,104px)] font-normal leading-[0.98] text-text-primary">
                Transform
                <br />
                Overwhelm
                <br />
              ...
              <p className="mb-[clamp(22px,3vw,44px)] max-w-[clamp(420px,44vw,680px)] text-[clamp(16px,1.55vw,22px)] leading-[1.7] text-text-secondary">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="cursor-pointer whitespace-nowrap rounded-xl border border-border bg-transparent px-[clamp(22px,2.5vw,40px)] py-[clamp(12px,1.3vw,16px)] text-[clamp(14px,1.25vw,20px)] font-semibold text-text-secondary"
                >
                  Watch Methodology
                </button>
              </div>
            </div>
            <div className="relative z-[1] flex justify-center pointer-events-none">
              <HeroMockup />
            </div>
          </div>
        </Section>
