    ...
    <Section className="py-24">
      <div className="mx-auto max-w-[860px]">
        <div className="rounded-[24px] border border-border bg-white p-[clamp(26px,3vw,44px)] text-center shadow-sm">
          <p className="mb-7 font-[Georgia,serif] text-[64px] leading-none text-border">&quot;</p>
          <p className="mb-9 font-display text-[28px] font-normal leading-[1.55] text-text-primary">
