...
const FeaturesSection = () => (
  <div id="features" className="bg-bg">
    <Section className="py-[clamp(96px,8.5vw,150px)]">
      <div className="grid items-center gap-[clamp(44px,6vw,96px)] [grid-template-columns:0.9fr_1.1fr]">
        <div>
          ...
          <div className="flex flex-col gap-[clamp(16px,1.8vw,26px)]">
            {features.map((f) => (
              <div key={f.title} className="flex items-start gap-[18px]">
                <div className="flex h-[clamp(38px,2.4vw,52px)] w-[clamp(38px,2.4vw,52px)] flex-shrink-0 items-center justify-center rounded-[14px] border border-[rgba(6,78,59,0.14)] bg-accent-light">
