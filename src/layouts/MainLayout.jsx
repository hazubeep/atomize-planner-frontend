  ...
  return (
    <div className="flex min-h-dvh w-full flex-col bg-bg bg-[radial-gradient(ellipse_at_top_right,#BFEBE433_0%,transparent_55%)]">
      <div className="flex min-h-dvh w-full flex-col">
        <header className="sticky top-0 z-40 flex h-[52px] shrink-0 items-center border-b border-border bg-white/85 px-5 backdrop-blur-md sm:px-10">
          {/* 1. Bagian Kiri (Logo) - Diberi flex-1 agar mengambil ruang yang tersedia */}
          <div className="flex flex-1 justify-start">
            <NavLink
              to="/home"
              className="no-underline"
            >
              <span className="font-display text-[15px] text-text-primary whitespace-nowrap">
                AtomizePlanner
              </span>
            </NavLink>
          </div>

          {/* 2. Bagian Tengah (Navigasi) - Dibuat shrink-0 agar tidak gepeng */}
          <nav className="flex shrink-0 gap-4 sm:gap-5">
          ...
          {/* 3. Bagian Kanan (Profile) - Diberi flex-1 dan justify-end agar sejajar di kanan */}
          <div
